...
void setup() {
  ...
  Serial.println((String)"Gyro X Cal: " + gyro_x_cal);
  Serial.println((String)"Gyro Y Cal: " + gyro_y_cal);
  Serial.println((String)"Gyro Y Cal: " + gyro_z_cal);
...
void loop(){
  ...
  //  Serial.print("Rol: ");
  //Serial.println(angle_roll);                                                      //Write the roll and pitch values to the LCD display
